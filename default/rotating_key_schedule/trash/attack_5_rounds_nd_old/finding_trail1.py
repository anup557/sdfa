# gist: calculate the trails for 5 rounds witn random msg, nibble val and nibble idx for 100 times and each of the time
...
def main():
    ...
    for round_num in range(80):
        ...
        if(round_num in [75, 76, 77, 78]):
            original_last_4_trail.append(state_diff)
    ...
    success = 0
    for i in range(4):
        if (trail_list[i+1][0] == original_last_4_trail[i]):
            success = success + 1
    if (success == 4):
        print('hola.')
