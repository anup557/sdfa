...
# 16 faults are given in some of the nibbles. In the second call 8 faults are given and in most of the cases
# the equivalent keyspace of 4 rounds are calculated.
# --------------------------------------------------------------------------------------------------------
...
def call_oracle(base_key, round_key, call_number):
    ...
    if (call_number == 1):
        ...
        # fix_fault_nibble = [8*i for i in range(4)] + [8*i+1 for i in range(4)]
