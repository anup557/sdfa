# gist: this is the default code for 52 rounds only as after 52 rounds, the core computation is done.
# ---------------------------------------------------------------------------------------------------
...
def oracle(msg, key_layer, key_core, state_list):
    ...
    # for default core, we only take 52 rounds
    no_of_rounds = 52
...
def fault_oracle(msg, key_layer, key_core, state_list, fault_round, fault_nibble, fault_val):
    # # defining number of rounds for default and core layer
    # no_of_rounds = 80
