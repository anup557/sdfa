# gist: calculate the trails for 2 rounds for baksheesh cipher with random msg, nibble val and nibble idx for 100
...
def main():
    ...
    # to store the original last 2 rounds trail
    ...
    print('original trail::', inv_perm(original_last_2_trail[0]), inv_perm(original_last_2_trail[1]))
