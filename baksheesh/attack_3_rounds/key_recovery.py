...
def main():
    ...
    #fix_fault_nibble = [0,1, 4,5, 8,9, 12,13, 16,17, 20,21, 24,25, 28,29] # of faults = 16, keyspace = unique verified
    #fix_fault_nibble = [0,1, 4, 8, 12,13, 16,17, 20, 24, 28,29] # of faults = 12, keyspace = unique verified
    fix_fault_nibble = [0,1, 4, 8, 12, 16,17, 20, 24, 28] # of faults = 16, keyspace = unique verified
